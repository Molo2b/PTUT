...
<body>
    ...
    <section class="container-fluid no-gutters py-5">
        <div class="row no-gutters">
            <div class="col-4">
                <img class="w-100" alt="phootographie d'une formation numérique" src="assets/img/article3.jpg">
                <h2>Les formations <br>proposées par duenes</h2>
            </div>
            <div class="col-3">
                <h4>Les ateliers</h4>
                ...
                <a class="d-block a-button">Consulter l'agenda +</a>
            </div>
            <div class="col-5">
                <div class="row">
                    <div class="col-12">
