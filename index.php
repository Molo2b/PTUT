...
<head>
  ...
  <title>DUENES - Page d'accueil</title>
...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-light bg-light" style="background: rgba(0,0,0,0)!important;">
        <a class="navbar-brand" href="#"><img alt="logo duenes" src="assets/img/logo.png"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">DUENES</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row">
            <div class="col-5">
                <div class="row h-100 row-cols-1">
                    <button class="col slider-title px-20perc">
    ...
    <section class="container-fluid p-5">
            <div class="row no-gutters">
                <h2><span class="hightlight">SUIVEZ</span> TOUTE <br> L’actualité de duenes</h2>
            </div>
    ...
    <section class="container-fluid no-gutters background-white vh-50 px-0">
            ...
            <div class="row no-gutters justify-content-around h-100 align-items-center py-5">
                ...
                <div class="offset-1 col-5 mr-auto">
                    <blockquote class="row">
                        ...
                        <footer> <em class="text-uppercase">Philippe DURAND </em><br><cite>Enseignant chercheur en Odontologie</cite></footer>
                    </blockquote>
                </div>
